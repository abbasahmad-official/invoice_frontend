...
{/* router.get("/client/search", listSearch); */}
      ...
      {createClient && <CreateClientForm onSuccess={()=> setShouldReloadClients(prev=> !prev)} setCreateClient={setCreateClient}  />}
      {client && <UpdateClientForm onSuccess={()=> setShouldReloadClients(prev=> !prev)} setUpdateClient={setUpdateClient} client={client} setClient={setClient} />}
      </Fragment>
  )
}
